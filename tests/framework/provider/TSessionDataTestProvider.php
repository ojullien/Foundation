...
trait TSessionDataTestProvider
{
    ...
    public function proceedTestNotStarted()
    {
        ...
        $this->object->setOffset('the_array', [ 'the_key' => 'the_value' ]);
        ...
        $this->object->setOffset('the_array', [ 'the_key' => 'the_value' ]);
        $this->assertFalse(
            $this->object->existsOffset('the_array'),
    ...
    public function proceedTestStarted()
    {
        ...
        $this->assertTrue(
            $this->object->existsOffset('the_key'),
            'existsOffset "the_key" after session_regenerate_id'
        );
        $this->assertSame(
            'the_value',
            $this->object->getOffset('the_key'),
        ...
        $this->assertEquals(
            [ 'the_key' => 'the_value' ],
            $this->object->getOffset('the_array'),
            'getOffset "the_array"'
        );
        // Check unset
        $this->object->unsetOffset(0);
    ...
    public function proceedTestWriteAndClose()
    {
        ...
        $this->object->setOffset('the_array', [ 'the_key' => 'the_new_value' ]);
