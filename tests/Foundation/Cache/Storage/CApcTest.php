...
class CApcTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->_pObject = new \Foundation\Cache\Storage\CApc('FOUNDATION_TEST');
    }
     ...
     * @covers \Foundation\Cache\Storage\CApc
