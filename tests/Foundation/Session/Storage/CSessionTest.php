...
class CSessionTest extends \PHPUnit_Framework_TestCase
{
    ...
    /**
     * @var \Foundation\Session\Storage\CSession
     */
    protected $object;
    ...
    {
        $this->object = new \Foundation\Session\Storage\CSession();
    }
    ...
    /**
     * @covers \Foundation\Session\Storage\CSession::getName
     * @group specification
     */
    ...
    /**
     * @covers \Foundation\Session\Storage\CSession::setName
     * @group specification
    ...
    /**
     * @covers \Foundation\Session\Storage\CSession
     * @group specification
     */
    ...
    /**
     * @covers \Foundation\Session\Storage\CSession::setOffset
     * @group specification
